...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val balaraja = LatLng( -6.199264, 106.469193)
        mMap.addMarker(
            MarkerOptions().position(balaraja).title(getString(R.string.marker_in, "Balaraja"))
        )
        mMap.moveCamera(CameraUpdateFactory.newLatLng(balaraja))
